...
namespace Drupal\jazz_manage_bank_account_status\Form;
...
class StatusUpdateForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $user->set('field_account_bank_status_messag', $message);
    $tid = \Drupal::routeMatch()->getParameter('term');
    $user->set('field_account_bank_status', $tid);
    if($tid == 32)
    {
      $user->set("status", 1);
    }
    ...
    $url = Url::fromUserInput('/admin/manage-account-bank-status');
