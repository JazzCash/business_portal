(function($, Drupal) {
    $(document).ready(function() {
        ...
        jQuery('#edit-submit').text('Update Account');
        jQuery('.alert-success').find('p').text('Account Updated Successfully');
        ...
        attach: function(context, settings) {
            $(context).find(".custom-register").once('make-step').each(function() {
                ...
                let stepBeforeNext = {
                    ...
                    //     </h2>
                    //     <p>Just one quick check to verify your account. We’ve sent verification codes to irum.tariq@hotmail.com & +923008764903</p>
                    //     <div>
                    //     <div>
