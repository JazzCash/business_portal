...
class RegsiterController extends ControllerBase
{
  ...
  public function main()
  {
    ...
    $form['#theme'] = 'custom_edit_form';
    $form['#attached']['library'][] = 'user_edit/edit-steps';

    // $form['redirectIt']['#markup'] = "HELLO WORLD";

    // $form['actions']['submit']['#submit'][] = 'redirectaccount';
    // array_unshift($form['actions']['submit']['#submit'], 'redirectaccount');
    // d_limit($form['actions']['submit']);
