...
namespace Drupal\user_profile_current\Plugin\Block;

use Drupal\Core\Block\BlockBase;

/**
 * Provides a 'UserProfileCurrentBlock' block.
 *
 * @Block(
 *  id = "user_profile_current_block",
 *  admin_label = @Translation("User profile current block"),
 * )
 */
class UserProfileCurrentBlock extends BlockBase
{
  ...
  public function build()
  {
    ...
    $build['#attached']['library'][] = 'user_profile_current/userprofilecurrent';
    $build['user_profile'] = [
      '#theme' => 'user_profile_current_block',
      '#data' => [
        'content' => $content,
      ]
    ];
