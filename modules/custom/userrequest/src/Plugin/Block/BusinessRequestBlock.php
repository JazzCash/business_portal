...
/**
 * Provides a 'BusinessRequestBlock' block.
 *
 * @Block(
 *  id = "business_request_block",
 *  admin_label = @Translation("Business request block"),
 * )
 */
class BusinessRequestBlock extends BlockBase {
