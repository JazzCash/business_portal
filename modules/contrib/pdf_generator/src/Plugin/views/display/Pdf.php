...
class Pdf extends PathPluginBase implements ResponseDisplayPluginInterface, ContainerFactoryPluginInterface {
  ...
  public static function buildResponse($view_id, $display_id, array $args = []) {
    ...
    $showPagination = !empty($view->display_handler->getOption('show_pagination')) ? $view->display_handler->getOption('show_pagination') : 0;
    $paginationX = !empty($view->display_handler->getOption('pagination_x')) ? $view->display_handler->getOption('pagination_x') : 0;
    $paginationY = !empty($view->display_handler->getOption('pagination_y')) ? $view->display_handler->getOption('pagination_y') : 0;
    ...
    $response = \Drupal::service('pdf_generator.dompdf_generator')->getResponse($title, $output, FALSE, [], $pageSize, $showPagination, $paginationX, $paginationY, $disposition, $textCss, $fileCss);
    return $response;
  }
